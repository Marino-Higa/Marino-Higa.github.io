<?php get_header(); ?>
        ...
        <div class="row">
          <div class="col-md-6">
            <a
              ...
              class="bnr"
              style="
                background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/home/bnr_about@2x.jpg');
              "
            >
              <div class="bnr_inner">お店について<span>ABOUT</span></div>
            </a>
          </div>
          ...
          <div class="col-md-6">
            <a
              ...
              class="bnr"
              style="
                background-image: url('<?php echo get_template_directory_uri(); ?>/assets/img/home/bnr_access@2x.jpg');
              "
            >
    ...
    <section class="sec sec-bg">
      <div class="sec_inner">
        ...
        <div class="sec_btn">
          <a href="<?php echo get_permalink(27); ?>" class="btn btn-default"
            >メールフォーム<i class="fas fa-angle-right"></i
          ></a>
        </div>
      </div>
    </section>
